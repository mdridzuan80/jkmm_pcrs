            ...
            <div class="col-md-12">
                <div class="box box-primary" >
                    <div class="box-body table-responsive" style="overflow-x:hidden;">
                        ...
                        <form target="_blank" id="form-laporan-harian" name="harian" method="POST" action="{{ route('pdf.laporan.harian') }}">
                                @csrf
                                ...
                                <table class="table table-bordered" style="font-size:14px !important;">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <button type="button" id="cmdJanaLaporanHarianAll" class="btn btn-primary btn-flat" name="btn_papar">Papar</button>
