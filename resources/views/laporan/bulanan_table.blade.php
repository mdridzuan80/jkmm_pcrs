...
<table style="width:100%">
    <tr>
        <td style="width:100%; text-align:center;"><img src="{{ asset('images/jata_melaka_100.png') }}" style="width:80px; height:auto;" /></td>
    </tr>
</table>
...
<table class="table table-hover table-striped biasa" style="font-size: 14px !important;">
  ...
  <tbody> 
            ...
            <tr <?php if(($hari_malay == 'Sabtu') || ($hari_malay == 'Ahad')){ echo ' style="background-color: #fffee9;"'; } ?>>
