  ...
  <tbody> 
			...
			*/
            ...
            <tr style="background-color:<?php echo $color_row; ?>;">
                <td style="width:8%">{{ date("d/m/Y", strtotime($datetarikh->tarikh)) }}<br>{{ '('.$hari_malay.')' }}</td>
				...
				<!--<td style="width:11%" align="center"><div class="column_kesalahan"><?php //echo $kesalahan_finaleALL.$nota_xcukup_9jam; ?></div></td>-->
				<td style="width:40%;">
