                ...
                <tr>
                    ...
                    <td>
                        <div style="position: relative;">
                            <input id="departmentDisplay" class="form-control departmentDisplay" type="text" value="{{ optional(optional($profil->xtraAttr)->department)->deptname }}" style="background-color: #FFF;" readonly>
