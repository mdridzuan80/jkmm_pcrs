...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('bower_components\bootstrap-datetimepicker\bootstrap-datetimepicker.min.css') }}">
    ...
    <page backbottom="25mm">
        ...
        <div class="format_laporan_bulanan">
            ...
            <table class="biasa" style="font-size:10px; width:100%;" width="100%">
                ...
                <thead>
                    <tr>
                        <th style="text-align:center; width:8%">TARIKH</th>
                        <th align="center" style="text-align:center; width:11%">WBB</th>
                        <th align="center" style="text-align:center; width:9%">CHECK-IN</th>
                        <th align="center" style="text-align:center; width:9%">CHECK-OUT</th>
                        <th align="center" style="text-align:center; width:7%">JAM</th>
                        <th align="center" style="text-align:center; width:11%">KESALAHAN</th>
                        <th align="center" style="text-align:center; width:40%">CATATAN</th>
                        <th align="center" style="text-align:center; width:5%">TT</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        @if ($datetarikh->anggota_id == $data_nama->anggota_id)
                            ...
                            /*
                            			if(strpos($datetarikh->kesalahan, 'NONEIN') !== false){
                            				$kesalahan_finale1 = "Pg: Tiada rekod";
                            				$check_dahadax++;
                            			}
                            			if(strpos($datetarikh->kesalahan, 'LEWAT') !== false){
                            				if($check_dahadax > 0){
                            				$kesalahan_finale2 = "<br>";
                            				}if($check_dahadax == 0){
                            				$kesalahan_finale2 = "";
                            				}
                            				$kesalahan_finale2 .= "Pg: Hadir lewat";
                            				$check_dahadax++;
                            			}
                            			if(strpos($datetarikh->kesalahan, 'NONEOUT') !== false){
                            				if($check_dahadax > 0){
                            				$kesalahan_finale3 = "<br>";
                            				}if($check_dahadax == 0){
                            				$kesalahan_finale3 = "";
                            				}
                            				$kesalahan_finale3 .= "Ptg: Tiada rekod";
                            				$check_dahadax++;
                            			}
                            			if(strpos($datetarikh->kesalahan, 'AWAL') !== false){
                            				if($check_dahadax > 0){
                            				$kesalahan_finale4 = "<br>";
                            				}if($check_dahadax == 0){
                            				$kesalahan_finale4 = "";
                            				}
                            				$kesalahan_finale4 .= "Ptg: Pulang awal";
                            				$check_dahadax++;
                            			}
                            			*/
                            ...
                            if (($status_cuti_umum = 'tidak') || $hari_malay != 'Sabtu' || $hari_malay != 'Ahad') {
                                //$kesalahan_finaleALL = $kesalahan_finale1.$kesalahan_finale2.$info_lewat.$kesalahan_finale3.$kesalahan_finale4.'['.$check_dahadax.']';
                            ...
                            <tr style="background-color:<?php echo $color_row; ?>;">
                                <td style="width:8%">
                                    {{ date('d/m/Y', strtotime($datetarikh->tarikh)) }}<br>{{ '(' . $hari_malay . ')' }}
                                </td>
                                ...
                                <td style="width:9%" align="center">{{ $checkin_finale }}</td>
                                <td style="width:9%" align="center">{{ $checkout_finale }}</td>
                                <td style="width:7%" align="center"><?php echo $beza_masaALL; ?></td>
                                <td style="width:11%" align="left"><?php echo $kesalahan_finaleALL . $nota_xcukup_9jam; ?></td>
                                <!--<td style="width:11%" align="center"><div class="column_kesalahan"><?php //echo $kesalahan_finaleALL.$nota_xcukup_9jam;
                                ?></div></td>-->
                                <td style="width:40%;">
