            ...
            <div class="col-md-12">
                <div class="box box-primary" >
                    <div class="box-body table-responsive">
                        ...
                        <form id="form-laporanrekodkehadiran1212" name="rekod_kehadiran" method="POST" action="{{ route('laporan.rekodkehadiran') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <button type="submit" id="cmdJanaLaporanKehadiranAll789-12" class="btn btn-primary btn-flat" name="btn_papar">Hantar</button>
