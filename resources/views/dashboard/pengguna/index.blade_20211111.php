...
<script>
    $(function() {
        ...
        $('#modal-default').on('keyup', '#txtPerkara', function(e) {
            acara.perkara = e.target.value;if (!e.target.value) {
            ...
            try {
                ...
                doc.autoTable({
                    ...
                    didDrawPage: function(data) {
                        ...
                        doc.writeText(data.settings.margin.left - 80, pageHeight - 70, "T/ T KETUA UNIT/ BAHAGIAN", {
                            align: 'right'
                        });
                        doc.text("Tarikh :", data.settings.margin.left, pageHeight - 40);
                        doc.writeText(data.settings.margin.left - 175, pageHeight - 40, "Tarikh :", {
                            align: 'right'
                        });
