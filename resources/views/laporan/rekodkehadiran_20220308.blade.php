            ...
            <div class="col-md-12">
                <div class="box box-primary" >
                    <div class="box-body table-responsive" style="overflow-x:hidden;">
                        ...
                        <form target="_blank" id="form-laporanrekodkehadiran1212" name="rekod_kehadiran" method="POST" action="{{ route('pdf.laporan.rekodkehadiran') }}">
                                @csrf
                                ...
                                <table class="table table-bordered" style="font-size:14px !important;">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <button type="button" id="cmdJanaLaporanKehadiranAll" class="btn btn-primary btn-flat" name="btn_papar">Hantar</button>
                                            <button type="submit" id="cmdJanaLaporanKehadiran_pdf" class="btn btn-success btn-flat" name="btn_pdf">Jana PDF</button>
			...
			*/
			$('#cmdJanaLaporanKehadiranAll789').on('click', function(e) {	
                ...
                $.ajax({
					...
					url: base_url+'laporan/rekodkehadiran' + comSenPPP + txtTarikh + txtTarikhHingga,
